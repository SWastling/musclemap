...
@pytest.mark.parametrize('fp, expected_output',
...
def test_register(tmp_path):
    ...
    fp_dict, to_delete = preproc.register(fp_dict, fp_dict['fa60_fp'],
                                  tmp_path, [], vercheck.get_fsldir(), False)
...
def test_register_dixon(tmp_path):
    ...
    fp_ref_dict = {'mminus1_fp': mminus1_fp,
                   'phiminus1_fp': phiminus1_fp,
                   'm0_fp': m0_ref_fp,
                   'phi0_fp': phi0_ref_fp,
                   'm1_fp': m1_ref_fp,
    ...
    fp_dict, to_delete = preproc.register_dixon(fp_dict, tmp_path, [],
...
def test_register_t2(tmp_path):
    ...
    fp_dict, to_delete = preproc.register_t2(fp_dict, reg_ref_fp, tmp_path, [],
                                             vercheck.get_fsldir(), False)
...
def test_mask(tmp_path):
    ...
    fp_ref_dict = {'mminus1_fp': mminus1_ref_fp,
                   'phiminus1_fp': phiminus1_ref_fp}
...
def test_crop(tmp_path):
    ...
    fp_ref_dict = {'a': a_ref_fp,
                   'b': b_ref_fp}

    fp_dict, to_delete = preproc.crop(fp_dict, crop_dims, tmp_path, [],
                                      vercheck.get_fsldir(), False)
...
def test_resample(tmp_path):
    ...
    fp_dict, to_delete = preproc.resample(fp_dict, res_ref_fp, tmp_path, [],
                                          vercheck.get_fsldir(), False)
...
def test_create_mask(tmp_path):
    ...
    bg_mask_fp, to_delete = preproc.create_mask(res_ref_fp, tmp_path, [],
                                                vercheck.get_fsldir(), False)
